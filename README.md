...
## Setup / Run Instructions (VS Code + Conda)
This repo is already configured to work with a conda environment named `embryo_env`.

1) **Create / activate the conda environment**

```bash
conda create -n embryo_env python=3.10 -y
...
pip install numpy pandas matplotlib pillow scikit-learn seaborn tqdm ipykernel
```

3) **Register the Jupyter kernel**

```bash
python -m ipykernel install --user --name embryo_env --display-name "Python (embryo_env)"
```

4) **Run the notebook**
- Open [notebook13d48ed937 (1).ipynb](notebook13d48ed937%20(1).ipynb)
- Select kernel **Python (embryo_env)**
- Run cells top-to-bottom

5) **Recompute the summary table**
